...
in
{
  "@johannesloetzsch/http-server" = nodeEnv.buildNodePackage {
    name = "_at_johannesloetzsch_slash_http-server";
    packageName = "@johannesloetzsch/http-server";
    version = "14.0.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/@johannesloetzsch/http-server/-/http-server-14.0.1.tgz";
      sha512 = "qA0iDNkw31G7gkrAR1wcXpsoYxB0OWnESF1LdMc2RPzXrDt7dIY5zbViWX9nvgh3mJVkvtik6zwoAf93r13uXQ==";
    };
    dependencies = [
      sources."async-2.6.3"
    ...
    meta = {
      ...
      homepage = "https://github.com/johannesloetzsch/http-server#readme";
      license = "MIT";
    };
    production = true;
    bypassCache = true;
