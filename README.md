This is a fork of https://github.com/http-party/http-server.

It contains a [--spa option](https://github.com/http-party/http-server/pull/772) and a nix flake.

```shell
  nix shell github:johannesloetzsch/http-server/nix --command http-server
```
